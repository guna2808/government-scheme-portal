...
<%
    ...
    try {
        ...
        PreparedStatement ps = con.prepareStatement("SELECT fullname, email, role FROM admins WHERE username=?");
...
<body>
    <div class="profile-card">
        ...
        <a href="adminEditProfile.jsp" class="btn btn-edit">Edit Profile</a>
        <a href="confirmAdminDelete.jsp" class="btn btn-delete">Delete Profile</a>
